    ...
    return (
        <div className='max-w-[1700px] mx-auto py-20'>
                ...
                <div className='flex flex-col md:flex-row justify-center items-center space-x-10'>
                    ...
                    <div className='w-full'>
                        <div className='border-b-2 border-gray-300'>
                            <h1 className='font-semibold text-black text-[32px] text-center md:text-left'>{title}</h1>
                            <p className='text-gray-500 text-[20px] pb-5 text-center md:text-left'>Developed by <span className='font-semibold text-[#9F62F2]'>{companyName}</span></p>
                        </div>
                        <div className='pt-5 flex flex-wrap md:flex-row'>
                            <div className='max-w-fit mx-auto lg:mx-10 md:-ml-0 lg:-ml-0'>
                                ...
                                <div className='md:-mt-2'>
                                    <p className='md:text-[40px] text-black text-2xl font-bold'>{downloads}M</p>
                                </div>
                            </div>
                            <div className='max-w-fit mx-auto lg:mx-10'>
                                ...
                                <div className='md:-mt-2'>
                                    <p className='md:text-[40px] text-black text-2xl font-bold'>{ratingAvg}</p>
                                </div>
                            </div>
                            <div className='max-w-fit mx-auto lg:mx-10'>
                                <div>
                                ...
                                <div className='md:-mt-2'>
                                    <p className='md:text-[40px] text-black text-2xl font-bold'>{reviews}K</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="rounded-lg">
                <h1 className='text-2xl font-semibold text text-black ml-13 py-5'>Ratings</h1>
            ...
            <div className='border-b-2 mt-10 mb-10 border-gray-300'></div>
            <div>
                <h1 className='text-2xl text-black font-semibold mb-5'>Description</h1>
