        ...
        <div>
            ...
            <div className='bg-[#f5f5f5] pt-20 px-2'>
                <div className='max-w-7xl mx-auto text-center'>
                    <h2 className='font-bold text-4xl md:text-6xl mb-10'>We Build <br /> <span className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] inline-block text-transparent bg-clip-text'>Productive</span> Apps</h2>
                    ...
                    <div className='flex items-center justify-center gap-4 mb-10'>
                        <button className='flex items-center justify-center border-1 border-gray-300 rounded-lg px-5 py-2 font-bold'><img src={icons1} alt="" style={{ width: '30px', height: '30px', marginRight: '10px' }} />Google Play</button>
                        <button className='flex items-center justify-center border-1 border-gray-300 rounded-lg px-5 py-2 font-bold'><img src={icons2} alt="" style={{ width: '30px', height: '30px', marginRight: '10px' }} />App Store</button>
                    </div>
